...
contains
  ...
  !   has a subset of full ij fields over its designated k-index range.
    ...
    use m_kinds, only: r_single,i_llong,i_kind
...
!                  rdx
  ...
  !$$$
    ...
    use m_kinds, only: r_single,i_llong,r_kind,i_kind
  ...
  !   do an initial read through of a wrf binary file, and get total number of sequential file records
    ...
    use m_kinds, only: i_byte,i_long,i_llong,i_kind
...
!   write(6,*)' byte_swap,lenrec,lenrec_swap=',byte_swap,lenrec(1),lenrec_swap
  ...
  !$$$
    ...
    use m_kinds, only: i_byte,i_llong,i_kind
    implicit none
  ...
  !$$$
    ...
    use m_kinds, only: i_byte,i_kind,i_llong,i_long
    use native_endianness, only: byte_swap
  ...
  !$$$
    ...
    use m_kinds, only: i_byte,i_kind,i_llong,i_long,r_single
    use native_endianness, only: byte_swap
    implicit none
